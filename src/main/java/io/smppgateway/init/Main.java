...
import io.smppgateway.events.service.consumer.EventsConsumer;
...
import io.smppgateway.config.loader.ConfigLoaderExternal;
import io.smppgateway.common.utilities.Utilities;
...
import static io.smppgateway.config.initialize.ConfigurationsSourceSMPP.SMPP_SERVICE_EVENTS_NAME;
import static io.smppgateway.config.initialize.ConfigurationsSourceSMPP.SMPP_SERVICE_EVENTS_NUM_CONSUMERS;
import static io.smppgateway.config.initialize.ConfigurationsSourceSMPP.METRICS_SERVER_PORT;
import static io.smppgateway.config.initialize.ConfigurationsSourceSMPP.HTTP_API_PORT;
import static io.smppgateway.config.initialize.ConfigurationsSourceSMPP.HTTP_API_ENABLED;
import static io.smppgateway.init.ServerMain.parseParameters;
